...
var APP_ID = process.env.LEANCLOUD_APP_ID || 'tVuqFHEzPODayxh6KggzBYpQ-gzGzoHsz';
var APP_KEY = process.env.LEANCLOUD_APP_KEY || '88yI9x1JsO4MfRPTyWJF0v7C';
var MASTER_KEY = process.env.LEANCLOUD_APP_MASTER_KEY || '4OvXHd9JnQmtbaAo43md8Urz';
...
var PORT = parseInt(process.env.LEANCLOUD_APP_PORT || process.env.PORT || 8000);
